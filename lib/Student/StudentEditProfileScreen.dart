...
class _StudentEditProfileScreenState extends State<StudentEditProfileScreen> {
  ...
  Future<void> _loadProfileData() async {
    ...
    setState(() {
      nameController.text = prefs.getString('name')?.isNotEmpty == true ? prefs.getString('name')! : 'Not Available';
      emailController.text = prefs.getString('email') ?? '';
      phoneController.text = prefs.getString('phone')?.isNotEmpty == true ? prefs.getString('phone')! : 'Not Available';
      campusController.text = prefs.getString('campus') ?? 'Not Available';
      ...
      child: SingleChildScrollView(
        child: ConstrainedBox(
          constraints: BoxConstraints(
            minHeight: MediaQuery.of(context).size.height, // Ensures full-screen scrollability
          ),
          child: Padding(
                        ...
                        Container(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage: _profileImage != null
                                ...
                                : null, // Removed default asset image
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 16),
                          _buildEditableInfoRow(Icons.person_outline, 'Full Name', nameController, _nameFocusNode),
                          const SizedBox(height: 16),
